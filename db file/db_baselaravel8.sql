...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2023 at 06:48 AM
...
CREATE TABLE `permissions` (
  ...
  `permission_grub` varchar(200) DEFAULT NULL,
...
CREATE TABLE `setting_web` (
  ...
  `sidebar_mode` varchar(50) DEFAULT NULL,
...
INSERT INTO `setting_web` (`id`, `app_name`, `app_alias`, `app_logo`, `sidebar_type`, `sidebar_mode`, `navbar_type`, `navbar_color`, `logo_bg_color`, `brand_type`) VALUES
(1, 'Base Laravel 8', 'BL8', '1668493259-laravel.png', 'dark', 'sidebar-collapse', 'light', 'pink', 'dark', 'light');
